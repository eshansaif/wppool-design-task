...
// const WPPOOLIndex = () => {
//   return (
//     <div className="bg-blue-900 text-white min-h-screen flex flex-col justify-center items-start pt-24 bg-[url('index_bg.png')] bg-no-repeat bg-local bg-center ">
//       <Navbar />
//       <div className="grid grid-cols-1 md:grid-cols-12 w-full max-w-6xl mt-16 px-8 py-4 ">
